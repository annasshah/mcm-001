...
const render_arr = [
  ...
  },
  {
    label: 'Response Time',
    key:'latest_event',
    render_value:(val) => val.latest_event.metrics.duration
  },
  {
    label: 'Checks',
    key:'schedule', 
          ...
          <div className="grid grid-cols-4 gap-4 ">

            {
              render_arr.map(({ label, key, type, render_value }, ind) =>{
                const extractedVal = render_value ? render_value(data) : data[key]
          ...
          <div className="bg-gray-100/75 py-2 px-3 rounded-md">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <dl className="col-span-4">
                ...
                <dd>{dns.name_servers.map((name, ind)=><p key={ind}>{name}</p>)}</dd>
              </dl>
