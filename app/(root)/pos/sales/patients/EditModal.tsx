                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-1/2 py-4">
                            ...
                            <div className='w-full space-y-4'>
                                <Input_Component bg_color='bg-[#D9D9D9]' label='Name' />
                                <Input_Component bg_color='bg-[#D9D9D9]' label='Email Address' />
                                <Input_Component bg_color='bg-[#D9D9D9]' label='Phone Number' />
